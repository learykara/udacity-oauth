...
def gconnect():
    ...
    output = (
        "<h1>Welcome, {}!</h1><img src={} style='width: 300px;"
        "height: 300px; border-radius: 150px;-webkit-border-radius: 150px;"
        "-moz-border-radius: 150px;'>").format(
            login_session.get('username'), login_session.get('picture'))
    flash('You are now logged in as {}'.format(login_session.get('username')))
    return output
